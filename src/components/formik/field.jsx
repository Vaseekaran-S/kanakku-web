...
function FormikField({ name, errorMsg, type, ...props }) {
  ...
  return (
    <div className='mb-3 relative'>
      <Field name={name} {...props} type={isPassword && isPasswordVisible ? "text" : type} className="w-full border border-green-300 px-3 py-2 rounded focus:outline-none focus:border-green-600" />
